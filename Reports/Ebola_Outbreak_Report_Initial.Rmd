...
Among cases, the average number of persons living in their households was `r hhsize_summary$mean_hhsize`. On average, there were `r hhsize_summary$mean_hh_cases` cases per household, and thus approximately `r hhsize_summary$mean_hh_prop_infected * 100`% of households were affected.
...
**Figure 3: Weekly incidence over the 3-month reporting period.** The grey bars show the reported
...
**Figure 4: Estimates of the weekly reproductive number over time.** The black line shows the 
...
<br>
**Figure 5: Average weekly waiting time.**
<br>
<br>
...
3. Over half of households become infected -- need to screen within households get vaccines to household members after first person infected.
4. Women seem to be particularly at risk of becoming infected, though not necessarily dying.
