...
<br>
The following figures show the time trend in cases as observed from the data.
...
```
<br>
**Figure 1: The total number of reported cases by week of the year**
...
```
<br>
**Figure 2: Cummulative case counts by week of the year**
<br>
<br> 
```{r epicurve_status}
...
**Figure 3: The total number of reported cases by week of the year clustered by case definition**
<br>
<br> 
...
**Figure 4: Cummulative case counts by week of the year clustered by case definition**
<br>
<br>
...
<br>
**Figure 5: The total number of reported cases by week of the year clustered by case outcome**
<br>
<br>
...
```
<br>
**Figure 6: Cummulative case counts by week of the year clustered by case outcome**
<br>
<br>
...
library('incidence');library('ggplot2');library('magrittr')
...
with caution as the confidence interval is very wide. The basic reproductive number
was estimated at `r signif(estR0$estimates$EG$R,3)`(`r signif(estR0$estimates$EG$conf.int[1],3)`,
`r signif(estR0$estimates$EG$conf.int[2],3)`)
<br>
<br>
